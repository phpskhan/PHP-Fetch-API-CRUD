...
function loadTable(){ 
	...
	.then((data)=>{
		...
		if(data['empty']){
			...
			for(var i in data){
				tr += `<tr>
		            <td align="center">${data[i].client_id}</td>
		            <td>${data[i].client_fullName}</td>
		            <td>${data[i].client_gender}</td>
		            <td>${data[i].client_dateOfBirth}</td>
		            <td>${data[i].client_age}</td>
		            <td>${data[i].client_weight}</td>
		            <td>${data[i].client_height}</td>
		            <td align="center"><button class="edit-btn" onclick="editRecord(${data[i].profile_id})">Edit</button></td>
		            <td align="center"><button class="delete-btn" onclick="deleteRecord(${data[i].profile_id})">Delete</button></td>
		          </tr>`;
			}
			tbody.innerHTML = tr;
		}
